...
//    }
    ...
    public ArrayList<RecommendedDomain> getListObject(String key){
        Gson gson = new Gson();
        ArrayList<String> objStrings = getListString(key);
        ArrayList<RecommendedDomain> playerList =  new ArrayList<RecommendedDomain>();
        for(String jObjString : objStrings){
            RecommendedDomain player  = gson.fromJson(jObjString,  RecommendedDomain.class);
...
//    }
    ...
    public void putListObject(String key, ArrayList<RecommendedDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(RecommendedDomain player: playerList){
